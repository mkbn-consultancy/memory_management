...
int main() {
    ...
    std::cout<<"alignment: "<<reinterpret_cast<uintptr_t>(&Vec) % alignof(Vec3d)<<" from alignment\n";
    ...
    std::cout<<"alignment: "<<reinterpret_cast<uintptr_t>(pVec) % alignof(Vec3d)<<" from alignment\n";
